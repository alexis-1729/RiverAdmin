                                    ...
                                    <tbody>
                                      ...
                                      <?php  foreach($datos as $dato) {?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url().'/dispositivos/editar/'. $dato['circuito_id'];?>" class="btn btn-info">
                                                        <i class="fa-solid fa-pen-to-square"></i></a></td>
                                                        <td><a href="<?php echo base_url().'/dispositivos/eliminar/'. $dato['circuito_id'];?>" class="btn btn-warning">
