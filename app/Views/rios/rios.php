                                      ...
                                      foreach($datosp as $dato) {
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url().'/rios/editar/'. $dato['monitoreo_id'];?>" class="btn btn-info">
                                                        <i class="fa-solid fa-pen-to-square"></i></a></td>
                                                        <td><a href="<?php echo base_url().'/rios/eliminar/'. $dato['monitoreo_id'];?>" class="btn btn-warning">
